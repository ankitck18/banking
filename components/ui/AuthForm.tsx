...
const AuthForm = ({type}:{type: string}) => {
    ...
    const fornSchema = authFormSchema(type);
    const form = useForm<z.infer<typeof fornSchema>>({
      ...
      function onSubmit(values: z.infer<typeof fornSchema>) {
    ...
    <section className='auth-form'>
        ...
        <Link href="/" className="cursor-pointer flex items-center gap-1">
            <Image 
                ...
                alt="Horizon logo"
            />
            <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">LendNext</h1>
            </Link>
